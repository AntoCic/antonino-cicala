...
const featured = getSortedProjects().filter((p) => p.category === 'principale').slice(0, 3);
const totalCount = getSortedProjects().length;
          ...
          <Link to="/progetti" className={`${styles.card} ${styles.cardViewAll}`} aria-label="Vedi tutti i progetti">
            <div className={styles.viewAllInner}>
              ...
              <p className={styles.viewAllSub}>
                Scopri gli altri {totalCount - 3} progetti realizzati
              </p>
