...
export function buildSystemPrompt(description: string, faqsText: string): string {
  return `Sei "Anto AI", l'assistente virtuale di Antonino Cicala, un Full Stack Developer freelance.
