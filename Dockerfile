...
CMD ["sh", "-c", "npm --prefix functions install && npm --prefix functions run build && npm --prefix genkit install && npm --prefix genkit run build && firebase emulators:start --project antonino-cicala --import=./emulator-data"]
